...
{
    /// <summary>
    /// Set LaserDesignator maxTargets to 12 for cooperative strikes on the KR-67R.
    /// The KR-67A base has 2 targeting lasers (set by QoL). The R variant gets 12.
    /// </summary>
    ...
    public static class LaserDesignatorPatch
    {
        ...
        public static void Postfix(LaserDesignator __instance)
        {
            ...
            if (Plugin.IsKR67R(aircraft))
            {
                ...
                Debug.Log("[KR-67R] Laser designator set to 12 targets for cooperative strikes.");
            }
        }
    }
}
